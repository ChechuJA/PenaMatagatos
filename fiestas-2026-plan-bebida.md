...
Compra final 2026 = max(Objetivo base 2026 - Sobrante util 2025 + Colchon, 0)

Recomendacion de colchon:
- 10% en cerveza y refrescos.
- 5% en destilados.
...
- Prioridad 2: si un producto queda por encima del 20% sin consumir, recortar su objetivo base un 15% para 2027.
- Prioridad 3: registrar consumo real por dia (jueves, viernes, sabado, domingo) para afinar mejor el siguiente ano.
